...
public:
    ...
    int getEnergy() const;
    int getDef() const;
    virtual int getSpecialSkillCost() const { return 0; }
    virtual void updateMoral(BattleContext &context, bool isSpecialSkill);
    int getMaxHp() const;
    void receiveSanji(Character *target) const;
    void receiveNami(Character *target) const;
    void healFromChopper(Character *target, int healAmount) const;
    int getSpeed() const;
    void receiveUssop(Character *target) const;
    int getAtk() const;
    void receiveFranky(Character *target) const;
    void receiveKalifa(Character *target) const;
    bool lowestHpTag() const;
    void setIsLowest(bool isLowest);
...
public:
    ...
    int getSpecialSkillCost() const override { return 20; }
};
...
public:
    ...
    int attack(Building *target, BattleContext &context);
    int specialSkill(Building *target, BattleContext &context);
    int getSpecialSkillCost() const override { return 15; }
...
public:
    ...
    int attack(Building *target, BattleContext &context);
    int specialSkill(Building *target, BattleContext &context);
    int getSpecialSkillCost() const override { return 18; }
...
public:
    ...
    int attack(Building *target, BattleContext &context);
    int specialSkill(Building *target, BattleContext &context);
    int getSpecialSkillCost() const override { return 16; }
    void endTurn(BattleContext &context);
};
...
public:
    ...
    int attack(Character *target, BattleContext &context);
    int specialSkill(Character *target, BattleContext &context);
    int getSpecialSkillCost() const override { return 25; }
    void endTurn(BattleContext &context);
};
...
public:
    ...
    int attack(Character *target, BattleContext &context);
    int specialSkill(Character *target, BattleContext &context);
    int getSpecialSkillCost() const override { return 14; }
    void endTurn(BattleContext &context);
};
